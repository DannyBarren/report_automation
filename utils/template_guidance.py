            ...
            rules.append(
                {
                    ...
                    "field_values_contract": (
                        "Populate field_values with EVERY key listed in fields. "
                        "Use labels from field_specs. "
                        "severity must be one of: no_issue, minor, moderate, major, safety_critical, informational. "
                        "If narration reports no problems, use no_issue or minor with explicit 'no issues' wording."
                    ),
                }
            )
